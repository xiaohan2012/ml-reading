...
**核心问题**：TabICL 的 column embedder 已完成大部分信息提取，row-wise interaction 几乎只需 1 层。

- "0 层 row-interaction"消融：直接用 column embedder 输出预测，性能下降多少
...
**核心问题**：本文覆盖的模型（TabPFN v1/v2/v2.5、TabICL、LimiX）均为 2024-2025 年的工作，更新的模型是否有相同的规律？
