...
- [graphgps](graphgps.md): same team; GPSE extends GPS's PE taxonomy to a pre-trained universal encoder.
- [limsign](limsign.md): SignNet is one of the PSE types encoded by GPSE.
