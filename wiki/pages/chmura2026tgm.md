...
- [gu2026relbench](gu2026relbench.md)

## Relation to Other Wiki Pages

- [temporal-graph](temporal-graph.md): TGM is the primary software infrastructure for this concept.
- [xu2020tgat](xu2020tgat.md): TGM natively supports TGAT as one of its CTDG model implementations.
- [rossi2020tgn](rossi2020tgn.md): TGM natively supports TGN; TGN's modular memory/embedding design parallels TGM's hook-based architecture.
- [yu2023dygformer](yu2023dygformer.md): TGM natively supports DyGFormer (CTDG Transformer); DyGLib (DyGFormer's companion library) is a predecessor that TGM supersedes.
- [gu2026relbench](gu2026relbench.md): TGB datasets are integrated into RelBench v2 via relational schema translation, creating a bridge between TGM's temporal graph domain and the RDL benchmark ecosystem.
