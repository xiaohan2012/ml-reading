...
- [ranjan2025relationaltr](ranjan2025relationaltr.md): RT vs. RelGT is a key contrast — same RDL problem, opposite design philosophies. RelGT uses rich schema-specific positional encodings for best supervised performance; RT omits all PEs for zero-shot generalization.
- [relbench](relbench.md): RelGT evaluated on v1; [gu2026relbench](gu2026relbench.md) is the expanded benchmark.
