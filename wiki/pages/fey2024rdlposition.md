...
- [robinson2024relbench](robinson2024relbench.md): the companion benchmark paper (Robinson et al., NeurIPS 2024) provides the full 7-database, 30-task expansion with empirical validation.
- [dwivedi2025relgt](dwivedi2025relgt.md): RelGT builds directly on the RDL blueprint; its 5-element tokenization and temporal sampling are extensions of the framework defined here.
- [ranjan2025relationaltr](ranjan2025relationaltr.md): RT fulfills the foundation model vision the blueprint paper explicitly calls for; it drops positional encodings to enable schema-agnostic zero-shot transfer.
- [chmura2026tgm](chmura2026tgm.md): TGM's CTDG temporal message passing (TGAT, TGN) is the temporal graph precursor that the RDL blueprint generalizes to the heterogeneous relational setting.
