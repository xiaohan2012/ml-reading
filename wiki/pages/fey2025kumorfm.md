...
- **Predecessor to** [fey2025kumorfm2](fey2025kumorfm2.md): v2 adds hierarchical two-stage attention, task-conditioned processing, billion-scale SQL/graph engine support, and stronger results
- **Uses** [dwivedi2025relgt](dwivedi2025relgt.md) (RelGT by Dwivedi et al. 2025) as its table-wise interaction backbone
- **Contrasts with** [ranjan2025relationaltr](ranjan2025relationaltr.md) (RT): KumoRFM uses row-level tokens + FK graph attention + explicit ICL module vs. RT's cell-level Relational Attention masks; both are schema-agnostic but different architectures
- **Contrasts with** [wang2025griffin](wang2025griffin.md): KumoRFM uses ICL for zero-shot transfer; Griffin uses meta-learning; both use GNN across tables
