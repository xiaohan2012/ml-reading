...
sources: [relational-graph-transformer, relational-transformer, graphgps, generalization-transformer-graphs, graphormer, san, attention-graphs-gt-interpretability]
updated: 2026-04-30
---
...
- [graphgps](graphgps.md) — foundational GPS recipe: MPNN ∥ GlobalAttn per layer; PE/SE taxonomy; O(N+E) with linear attention; SOTA on 11/16 benchmarks
- [generalization-transformer-graphs](generalization-transformer-graphs.md) — Dwivedi & Bresson (AAAI 2021): first GT formalization; sparse neighborhood attention + LapPE + BatchNorm; edge features × attention scores
