...
- **Tokenization granularity**: row-level (most GTs, including RelGT) vs. cell-level ([Relational Transformer](ranjan2025relationaltr.md))
...
- [RelGT](dwivedi2025relgt.md): row-level tokens, rich 5-element positional encodings, schema-specific, best supervised performance.
- [Relational Transformer (RT)](ranjan2025relationaltr.md): cell-level tokens, no positional encodings, schema-agnostic, enables zero-shot transfer. RT's neighbor attention is equivalent to GNN message passing.
...
- **[SAN](kreuzer2021san.md)** (Kreuzer et al., NeurIPS 2021): full Laplacian spectrum as LPE; provably exceeds 1-WL; first fully-connected model competitive on graph benchmarks
