...
sources: [hgt, relational-graph-transformer, relgnn]
updated: 2026-04-29
---
...
[RelGT](relational-graph-transformer.md) consistently outperforms both HGT and HGT+PE across RelBench while avoiding the costly PE precomputation — using its [subgraph GNN PE](subgraph-gnn-pe.md) instead.

## Appearances in Sources

- [hgt](hgt.md) — original paper; meta-relation triplet parameterization, RTE, HGSampling; 9%–21% gains on OAG
- [relational-graph-transformer](relational-graph-transformer.md) — used as the primary GT baseline; shown to be inadequate for RDL
- [relgnn](relgnn.md) — explains *why* standard heterogeneous GNNs underperform: semantic-edge assumptions don't hold for PK-FK links; bridge/hub topology causes redundant and imbalanced message passing
