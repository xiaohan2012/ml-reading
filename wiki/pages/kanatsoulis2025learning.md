...
- [limsign](limsign.md): SignNet achieves expressiveness but at high cost; PEARL achieves comparable expressiveness with linear complexity.
- [huangstability](huangstability.md): SPE achieves stability but at eigenvector-computation cost; PEARL achieves both stability and linear complexity via GNN.
