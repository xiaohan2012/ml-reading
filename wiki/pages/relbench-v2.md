...
- [relational-transformer](relational-transformer.md): RT uses RelBench for pretraining; references v2 autocomplete tasks.
- [relational-graph-transformer](relational-graph-transformer.md): RelGT was evaluated on RelBench v1; v2 is the expanded successor benchmark.
- [tgm-temporal-graph-modelling](tgm-temporal-graph-modelling.md): TGB datasets integrated into v2 via relational schema translation.
