...
- [relational-deep-learning-position](relational-deep-learning-position.md): RelGNN builds directly on the RDL blueprint; bridge/hub analysis is a first structural characterization of REG topology that the blueprint paper didn't address.
- [relational-graph-transformer](relational-graph-transformer.md): RelGT uses rich 5-element tokenization on the same REG; RelGNN shows that fixing message-passing topology is itself sufficient for large gains without positional encodings.
