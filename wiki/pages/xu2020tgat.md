...
- [rossi2020tgn](rossi2020tgn.md): TGN generalizes TGAT by adding the memory module; TGAT = TGN-no-mem; TGN-attn is strictly better and faster.
- [velickovic2018gat](velickovic2018gat.md): TGAT is GAT extended to temporal graphs — replaces standard positional encoding with Bochner time encoding; adds causal masking over temporal neighborhoods.
